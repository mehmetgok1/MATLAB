...
\lstinputlisting[language=Verilog-A, caption={Verilog-A PV Model Implementation}, label={code:pv_model_va}]{verilogacode/pv_model}
...
\lstinputlisting[caption={Duty Cycle Integrator SystemVerilog Implementation}, label={code:duty_int}]{systemverilogcode/duty_integrator.sv}
...
\lstinputlisting[caption={Duty Cycle Integrator SystemVerilog Implementation}, label={code:duty_int_dig}]{systemverilogcode/dig/rtl/duty_integrator.sv}
