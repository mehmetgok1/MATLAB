...
\begin{figure}[H]
    \centering
    \subfigure[Zoomed-in view of FLC activation at 0.2s.]{\includegraphics[width=0.7\textwidth]{matlab/matlab_sim_result_around0_2.jpg}\label{fig:sim_zoom_02}}
    \vfill
    \subfigure[Zoomed-in view of transient response at 0.4s.]{\includegraphics[width=0.7\textwidth]{matlab/matlab_sim_result_around0_4.jpg}\label{fig:sim_zoom_04}}
...
\begin{figure}[H]
    \centering
    \subfigure[DNL]{\includegraphics[width=0.8\textwidth]{figures/cadence_implement/ADC/capdac/dnlsim.png}\label{fig:capdac_dnl}}
    \vfill
    \subfigure[INL and its derivative]{\includegraphics[width=0.8\textwidth]{figures/cadence_implement/ADC/capdac/inlandderivinl.png}\label{fig:capdac_inl}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cadence_implement/ADC/ldo/ldo_schematic.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cadence_implement/ADC/ldo/ldo_stability.png} 
...
% Details on calculating dV and dI efficiently using digital registers.

\subsection{Fuzzification Simplifications}
% Details on avoiding division during membership degree calculation.

\subsection{Inference Engine Optimization}
% Details on LUTs or rule reduction.

\subsection{Defuzzification Simplifications}
% Details on replacing the weighted average multiplier/divider with shifts.

\subsection{Duty Integration}
% Details on the accumulator logic and digital damping.
