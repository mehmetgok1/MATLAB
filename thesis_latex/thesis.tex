...
% SystemVerilog Definition (Keep your existing one)
...
\chapter{BLOCK IMPLEMENTATIONS}
\label{chapter:implementation}

\section{Analog Implementation}
\label{sec:impl_analog}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cadence_implement/SARADC.drawio.png}
...
\subsubsection{CapDAC}

\subsubsection{Sample and Hold Switch}

\subsubsection{Preamplifier}

\subsubsection{Comparator}

\subsubsection{SAR Logic}
