module defuzzifier (
    ...
    // w1:-15, w2:15, w3:-1, w4:1, w5:1, w6:-1, w7:0, w8:0
    localparam signed [7:0] C1 = -15; // Big Decrease
    localparam signed [7:0] C2 =  15; // Big Increase
    localparam signed [7:0] C3 =  -1; // Decrease
    localparam signed [7:0] C4 =   1; // Increase
    localparam signed [7:0] C5 =   1; // Increase
    localparam signed [7:0] C6 =  -1; // Decrease
