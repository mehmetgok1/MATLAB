...
\renewcommand{\lstlistoflistings}{%
  \begingroup
  \let\oldnumberline\numberline
  \renewcommand{\numberline}[1]{\oldnumberline{\lstlistingname~##1.}}%
  \renewcommand\l@lstlisting{\@dottedtocline{1}{0em}{8em}}% Increase space to fit "Code Snippet"
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Fuzzy Logic Controller:} Implements the Sugeno inference engine, rule base, and duty cycle integrator.
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Duty Cycle Generator (PWM Adjuster):} This block compares the analog control voltage from the DAC against a high-frequency triangular waveform to generate the PWM signal. The resulting duty cycle is proportional to the control voltage, directly modulating the power flow through the buck converter.
